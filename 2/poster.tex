...
\veryHuge \color{NavyBlue} \textbf{Hofstadter butterfly in transistion metal dichalcogenides} \color{Black}\\ % Title
...
For example this work can be done with taking into account Coulomb interaction
\begin{gather}
 asdasdasdasdasadk 
\end{gather}
and 
